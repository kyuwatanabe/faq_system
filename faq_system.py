...
【シナリオの例】
- "I-94が回収されずに出国してしまった"
- "入国カードなしで入国した場合の出国手続き"
- "有効期間が残っているのに入国審査で短く判断された"
- "I-94を税関国境警備局に送付する必要がある"
- "FedExとUSPSのどちらで送ればよいか迷っている"

【絶対禁止シナリオ（抽出してはいけない）】
❌ "自分のビザの種類を正確に把握する方法を知りたい"
❌ "ビザ申請の条件を満たしているか判断したい"
❌ "どのビザを申請すべきか選びたい"
❌ その他、文章に具体的な記載がない一般的・抽象的なシナリオ

【重要ルール】
✓ 文章に**具体的に記載されている内容のみ**からシナリオを抽出すること
✓ 固有名詞（ビザ種類、書類名、制度名など）が含まれる具体的なシナリオであること
✓ 「自分の〜」「どのように判断〜」などの漠然とした表現は禁止
✓ 使用禁止シナリオは除外すること
...
✓ **完結性**: 質問単独で意味が通じること
✓ **自然さ**: 「〜してしまいました」「〜の場合は」など自然な表現を使うこと
✓ **文書依存性**: 情報源の文章に直接記載されている内容に基づいた質問であること

【回答作成の要件】
✓ **情報源に明確に記載されている情報のみ**を使用すること
✓ 一般論や推測を含めないこと
✓ 具体的な手続き・条件・例外などを記載すること
✓ 「ビザの種類によって異なる」などの漠然とした表現は避けること

【良い質問の例】
✓ "I-94が回収されずに出国してしまいました。どうすればよいですか?"
✓ "入国カードなしで入国した場合、出国時の手続きはどうなりますか?"
✓ "ビザウェーバープログラムで90日を超えて滞在する必要が生じた場合、延長できますか?"
✓ "ESTAを申請する際、渡航認証は何日前までに取得すべきですか?"

【絶対禁止の質問例】
❌ "自分のビザの種類を正確に把握し、その条件を満たしているかをどのように判断すればよいですか?"
❌ "ビザ申請の条件を満たしているかを確認する方法は?"
❌ "どのビザを申請すべきか判断する方法は?"
❌ その他、情報源に具体的な記載がない一般的・抽象的な質問
